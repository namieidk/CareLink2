        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              // FIXED ROW - Using Expanded and Flexible widgets to prevent overflow
              Row(
                children: [
                  ...
                  Flexible(
                    flex: 3,
                    child: Text(
                      'Last: ${DateFormat('MMM d').format(patient.lastVisit)}',
                      style: const TextStyle(
                        fontSize: 14,
                        color: Colors.grey,
                      ),
                ...
                child: const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text(
                        'This screen would show comprehensive information including:',
